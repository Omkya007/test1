...
export class ListComponent implements OnInit {
  ...
  students1 = [{ name: 'Amit', age: 20 }, { name: 'Pooja', age: 22 }];
   products2 = [{ id: 1, name: 'Laptop' }, { id: 2, name: 'Mobile' }]; 
   users = [{ id: 101, username: 'john' }, { id: 102, username: 'jane' }]; 
   languages = ['English', 'Hindi', 'Marathi', 'Tamil'];  countries = ['India', 'USA', 'UK', 'Canada'];
  hobbies = ['Singing', 'Dancing', 'Painting'];
  tasks = [{ task: 'Angular Practice', completed: false }, { task: 'Meeting', completed: true }];
  books1 = [{ title: 'Angular Basics', author: 'John' }, { title: 'TS Guide', author: 'Smith' }];
  posts = [{ id: 1, title: 'First Post' }, { id: 2, title: 'Second Post' }];
  employees1 = [{ name: 'Ravi', dept: 'HR' }, { name: 'Neha', dept: 'IT' }];
  courses1 = ['Angular', 'React', 'Vue'];
  scores = [85, 90, 75, 60];
  months = ['Jan', 'Feb', 'Mar', 'Apr'];
  events1 = ['Login', 'Logout', 'Register'];
  orders1 = [{ orderId: 1, item: 'Pen' }, { orderId: 2, item: 'Notebook' }];
  skills = ['JavaScript', 'TypeScript', 'Angular'];
  roles = ['Admin', 'Editor', 'User'];
  alerts = ['Success', 'Error', 'Warning'];
 statuses = ['Pending', 'In Progress', 'Completed'];
 flights1 = [{ flightNo: 'AI101', destination: 'New York' }, { flightNo: 'AI202', destination:
'London' }];
  expenses = [{ category: 'Food', amount: 250 }, { category: 'Travel', amount: 500 }];
